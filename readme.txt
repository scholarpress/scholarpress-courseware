...
== Installation ==
1. Unzip the download, and copy contents into a directory named `spcourseware`, then copy that directory into your wordpress plugins folder, normally located in /wp-content/plugins/. In ohter words, all files for the plugin should be in wp-content/plugins/spcourseware/
