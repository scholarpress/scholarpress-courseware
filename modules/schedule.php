...
if ( !class_exists( 'Scholarpress_Courseware_Schedule' ) ) :

class Scholarpress_Courseware_Schedule {
    
    function scholarpress_courseware_schedule() {
        add_shortcode('spschedule', array($this, 'shortcode'));
    ...
    function admin_menu() {
        if ( function_exists( 'add_submenu_page' ) ) {
            $schedule_title = __( "Schedule", SPCOURSEWARE_TD ) . ' | ' . __( "ScholarPress Courseware", SPCOURSEWARE_TD );
            add_submenu_page('scholarpress-courseware', $schedule_title, __( "Schedule", SPCOURSEWARE_TD ), 'manage_options', 'scholarpress-courseware-schedule', array($this, 'admin_display'));
        }
    }
...
$scholarpress_courseware_schedule = new Scholarpress_Courseware_Schedule();