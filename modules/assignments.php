...
if ( !class_exists( 'Scholarpress_Courseware_Assignments' ) ) :

class Scholarpress_Courseware_Assignments {
    
    function scholarpress_courseware_assignments() {
        add_action( 'admin_menu', array( $this, 'admin_menu' ) );
    }
    
    function admin_menu() {
        if ( function_exists('add_submenu_page') ) {
            $assignments_title  = __( "Assignments", SPCOURSEWARE_TD ) . ' | ' . __( "ScholarPress Courseware", SPCOURSEWARE_TD );
            add_submenu_page('scholarpress-courseware', $assignments_title, __( "Assignments", SPCOURSEWARE_TD ), 'manage_options', 'scholarpress-courseware-assignments', array($this, 'admin_display'));
        }
    }
...
$scholarpress_courseware_assignments = new Scholarpress_Courseware_Assignments();